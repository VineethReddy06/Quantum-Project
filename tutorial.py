...
def display_gate(gate_input):
    ...
    If the number of operation reach ten, ll gate buttons are disabled.
    """
...
def clear(circuit):
    """
    Clears the display!
    Reintializes the Quantum Circuit for fresh calculations!
...
def visualize_circuit(circuit,window):
    """
    Visualizes the single qubit rotations corresponding to apllied gates in a seperate tkinter window.
